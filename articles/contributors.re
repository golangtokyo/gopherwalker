...
==== Go Friday傑作選 / @tenntenn

メルカリ/ソウゾウ所属。Go Conference主催者。golang.tokyo、Goビギナーズ、GCPUG Tokyo運営。 大学時代にGoに出会い、それ以来のめり込む。 社内外で自ら勉強会を開催し、Goの普及に取り組んでいる。 マスコットのGopherの絵を描くのも好き。
...
==== 新しく型を定義することによって可能になる実装パターン / @pospome

株式会社DeNA所属。サーバサイドエンジニア。
クラス設計、DDDなどのアプリケーションアーキテクチャに興味を持つ。
