...
多くの場合、社内勉強会が通常業務に忙殺されて長続きしないことは、読者のみなさんもおそらく経験されてるでしょう。
...
ステータスなどを管理する際に、たとえば@<list>{tenntenn_list2}のように定数を用いることが多いでしょう。
...
また、その定数の値をデータベースに保存する必要がある場合は、なおさら@<code>{iota}は使うべきではないでしょう。
